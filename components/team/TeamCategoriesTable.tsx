    ...
    <Container>
      ...
      <DeleteModal
        {...{
          ...
          title: `Sterge categorie - ${teamCategory?.title}`,
          description: `Este sigur ca vrei sa stergi categoria  ${teamCategory?.title}?`,
          isLoading,
          onDeleteHandler,
      ...
      <TeamCategoryCUModal
        {...{
          ...
          title: `Editeaza categorie - ${teamCategory?.title}`,
          onSubmitHandler,
          isLoading,
